...
class Calculadora {
    ...
    imprimirDisplay() {
        ...
        this.textoValorSuperior.innerText = this.valorSuperior + " " + this.operador + " " + this.valorInferior
    }
    borrar (){
...
const darkMood = document.querySelector ('[data-dark]')
const lightMood = document.querySelector ('[data-light]')


lightMood.addEventListener('click' , () => {

    document.querySelector('body').classList.add('light')
    const buttomNum = document.querySelectorAll('[data-numero]')
